<style>
    body {
        ...
        background-image: url('/furreverfriends/app/resources/img/wow.jpg');
...
<form action="/furreverfriends/listpet" enctype="multipart/form-data" method="post">
    ...
    <label for="list_age">Age(in yrs):</label>
    ...
    <label for="list_nature">Colour:</label>
    <select id="list_nature" name="list_nature" required>
        <option value="Black">Black</option>
        <option value="Grey">Grey</option>
        <option value="White">White</option>
        <option value="Mixed:Grey and White">Mixed:Grey and White</option>
        <option value="Mixed:Black and White">Mixed:Black and White</option>
    </select>
